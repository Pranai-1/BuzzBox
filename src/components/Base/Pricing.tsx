...
export default function Pricing(){
    ...
    return(
        <div className="bg-gray-900 ">
         <span className="text-4xl p-2 font-bold text-white mb-2 flex justify-center">Designed for business teams like yours</span>
        ...
        <div id="pricing" className="h-full w-full py-5 flex flex-col md:flex-row flex-wrap gap-5 ">
