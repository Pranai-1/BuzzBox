...
export default function IndexBody(){
    ...
    return(
      ...
      <p> Experience an exciting free texting alternative to Find friends, connect with strangers, and</p>
       <p> talk with your family and friends in random anonymous chat rooms. No registration required. </p>
   ...
   <div className="mt-3 bg-gradient-to-b  from-teal-500 to-purple-600 md:bg-none md:mt-32 flex flex-wrap flex-col justify-center items-center">
    ...
    <p className=" text-gray-300 text-lg  font-medium rounded-xl mt-3">Find female and male strangers worldwide, the new modern texting
     alternative. </p>
